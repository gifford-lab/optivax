...
if __name__ == "__main__":
    ...
    if args.basement:
        if args.basefile:
            ...
            if '.txt' in args.basement:
                print "loading base protein from", args.basefile
    ...
    if args.nworker:
        best_solution,detail,beam_history=pc.beam_search_parallel(beam_size=args.beam_size,cutoff=args.coverage_cutoff,min_cutoff=args.lower_bound,\
                    max_round=args.max_round,curr_beam=curr_beam,curr_min=curr_min,nworker=args.nworker, bs=args.batchsize,diverse_cut=args.diversity,augment=True,upper=max_hist,lower=base_hist)
    else:
